			...
			<ul class="pagination ml-3">
				<c:if test="${!pager.start}">
					<li class="page-item"><a class="page-link"
						href="/tna/list?page=${pager.startNum-1}&search=${pager.search}">Previous</a></li>
			
				</c:if>
				<c:forEach begin="${pager.startNum}" end="${pager.lastNum}" var="p">
				<li class="page-item"><a class="page-link" href="/tna/list?page=${p}&search=${pager.search}">${p}</a></li>
				</c:forEach>
				
				<c:if test="${!pager.last}">
					<li class="page-item"><a class="page-link"
						href="/tna/list?page=${pager.lastNum+1}&search=${pager.search}">Next</a></li>
				</c:if>
			</ul>
			<form action="/tna/list" method="get">
