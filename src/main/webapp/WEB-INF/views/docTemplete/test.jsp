                    ...
                    <td
                                ...
                                <span class="sign_member_wrap" id="">
                                    <span class="sign_member">
                                        ...
                                        <span class="sign_wrap">
                                            <span class="sign_name"><strong>이름</strong></span>
                                        </span>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">                                   
                                ...
                                <button type="button" class="btn btn-primary">결재자 추가</button>
                                </div>
                            </div>
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td id="budgetTeamInfo" style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; height: 10px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
                        ...
                        <!-- Button trigger modal -->
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#referrerModal">
                                직원리스트
                            </button>
                            
                            <!-- Modal -->
                            <div class="modal fade" id="referrerModal" tabindex="-1" aria-labelledby="referrerModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                <div class="modal-content">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination">
                                                  ...
                                                  <li class="page-item">
                                                    <a class="page-link" href="./test?page=${pager.startNum-1}&search=${pager.referrerSearch}&kind=${pager.kind}" aria-label="Previous">
                                                  ...
                                                  <c:forEach begin="${pager.startNum}" end="${pager.lastNum}" var="i">
                                                          <li class="page-item"><a class="page-link" href="./test?page=${i}&search=${pager.referrerSearch}&kind=${pager.kind}">${i}</a></li>
                                                  </c:forEach>
                                                  
                                                  <c:if test="${!pager.last}">
                                                  <li class="page-item">
                                                    <a class="page-link" href="./test?page=${pager.lastNum+1}&search=${pager.referrerSearch}&kind=${pager.kind}" aria-label="Next">
                                                      <span aria-hidden="true">&raquo;</span>
                                                    </a>
                                                  </li>
                                                  </c:if>
                                                </ul>
                                                <form action="/docTemplete/detail" method="get">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" name="referrerSearch"
                                    ...
                                    <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">닫기</button>
                                    <button id="referrerAdd" type="button" class="btn btn-primary">참조자 추가</button>
                                    </div>
                                </div>
                                </div>
                            </div>
                    ...
                    <td id="quarterBudgetInfo"
                        ...
                        <input type="text" class="form-control" id="document_list" name="document_list">                        
                    </td>
                </tr>
                <tr>
                    <td
                    ...
                    <td id="productionCostInfo"
                        ...
                        <input type="file" name="file" class="form-control" onchange="addFile(this);" multiple>                          
...
function addFile(obj){
    ...
    for (let i = 0; i < Math.min(curFileCnt, remainFileCnt); i++) {
        ...
        document.querySelector("input[type=file]").value = file ;
    }
