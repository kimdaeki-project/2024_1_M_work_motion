...
<body>
	<div>
			...
			<form action="POST">		
				...
				<div class="mb-3">
					<label for="exampleInputPassword1" class="form-label">company_id</label>
				...
				<div class="mb-3">
					<label for="exampleInputPassword1" class="form-label">department_id</label>
					<input type="text" class="form-control"id="department_id" name="department_id" >
				</div> 
				<div class="mb-3">
					<label for="exampleInputPassword1" class="form-label">position_id</label>
