<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <span>
                <p style="line-height: 150%; font-family: 맑은 고딕; font-size: 10pt; margin-top: 0px; margin-bottom: 0px;">
                            ...
                            <td id="modal-approval"
                                ...
                                <p
                                    ...
                                    <span id="approval-list" class="sign_type1_inline"
                                        ...
                                        data-is-reception="" data-group-type="type1" data-group-max-count="7"
                                        data-group-name="결재선" data-group-seq="0">
                                         <input type="hidden" id="approval-member-id" name="approval"> 

                                         <span class="sign_tit_wrap">
                                            <span class="sign_tit"><strong>결재선</strong></span>
                                        </span>
                                        <c:forEach items="${dto.approvalDTOs}" var="f">                                           
                                            <span class="sign_member_wrap" id="">
                                                <span class="sign_member">
                                                    <span class="sign_rank_wrap">
                                                        <span class="sign_rank" data-department-id="0" id="approvla-department-name0">${f.memberDTO.department.name}</span>
                                                    </span>
                                                    <span class="sign_wrap">
                                                        <span class="sign_name" data-name-id="0" id="approval-name0">${f.memberDTO.name}</span>
                                                    </span>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="budgetTeamInfo"
                                ...
                                <c:forEach items="${dto.referrerDTOs}" var="r">
                                    ${r.memberDTO.name}
                                </c:forEach>
                            </td>
                            <td
