                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; width: 272px; height: 24px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
                                         <input type="text" class="form-control" id="create_dt" name="create_dt" readonly>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
			...
			<div class="modal-dialog">
				<div class="modal-content">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<c:forEach items="${list}" var="item">
									<tr>
										<td><input type="checkbox" class="member_id checkbox_save" data-department-name="${item.department.name}" data-member-name="${item.name}" data-referrer-id="${item.id}"></td>
										<td>${item.name}</td>
					...
					<div class="modal-footer">
						...
						<button id="approval-update" type="button" class="btn btn-primary" data-bs-dismiss="modal">결재자 추가</button>
					</div>
				</div>
			</div>
		</div>  
                    ...
                    <td id="productionCostInfo"
                        ...
                        <c:forEach items="${dto.documentFileDTOs}" var="df">
                        	<div class="input-group mb-3">
                        		<a href="/resources/upload/documentFiles/${df.name}">${df.ori_name}</a>
                        		<span input-group-text text-danger del >X</span>
                        	</div>							
						</c:forEach>
