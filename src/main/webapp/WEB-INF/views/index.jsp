...
<link rel="stylesheet" href="/resources/css/project/createTask.css"
	type="text/css" />
<!-- Font -->
...
<body class="sb-nav-fixed" data-bs-memberId="${member.id}">
	...
	<div id="layoutSidenav">
			...
			<nav class="sb-sidenav accordion sb-sidenav-dark"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link collapsed" href="/projects/list"
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav accordion"
								...
								<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
									...
									aria-controls="pagesCollapseAuth"> 문서작성
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
								<div class="collapse" id="pagesCollapseAuth"
									...
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="/docTemplete/list">서류 종류</a> <a
											class="nav-link" href="/tempDoc/list">임시저장</a>
									</nav>
								</div>
								<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
									data-bs-target="#pagesCollapseError" aria-expanded="false"
									aria-controls="pagesCollapseError"> 보관함
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
						...
						</a> <a class="nav-link collapsed" href="/department/departmentList"
							data-bs-target="#collapseHR" aria-expanded="false"
							aria-controls="collapseHR">
							<div class="sb-nav-link-icon">
								<i class="fas fa-book-open"></i>
						...
						</a> <a class="nav-link collapsed" href="/board/list?id=3"
							data-bs-target="#collapseHR" aria-expanded="false"
							aria-controls="collapseHR">
							<div class="sb-nav-link-icon">
								<i class="fas fa-book-open"></i>
						...
						</a> <a class="nav-link collapsed" href="/board/list?id=2"
							data-bs-target="#collapseHR" aria-expanded="false"
							aria-controls="collapseHR">
							<div class="sb-nav-link-icon">
								<i class="fas fa-book-open"></i>
						...
						</a> <a class="nav-link collapsed" href="/product/list"
							data-bs-target="#collapseHR" aria-expanded="false"
							aria-controls="collapseHR">
							<div class="sb-nav-link-icon">
								<i class="fas fa-book-open"></i>
		...
		<div id="layoutSidenav_content">
			<main class="h-100">
				...
				<div class="position-fixed bottom-0 animate__animated d-flex d-none"
					id="messenger">
					<div class="d-flex sidebar flex-column pe-1">
						<div class="closeButton ms-1 mb-3">
							<button type="button" class="btn btn-danger"
								id="closeMessengerButton">x</button>
						</div>

						<ul class="nav flex-column align-items-center" id="myTab"
							role="tablist">
							<li class="nav-item mt-2 mb-4" role="presentation">
								<button class="nav-link text-muted active" id="home-tab"
							...
							<li class="nav-item mt-3 mb-3" role="presentation">
								<button class="nav-link text-muted" id="messages-tab"
					...
					<div class="w-100" id="messengerBody">
						<div class="p-3 d-flex justify-content-between">
							...
							<div>
								<a href="#"> <i class="fas fa-search fw-lighter"></i>
								</a>
							</div>
						</div>

						<div class="overflow-auto tab-content" id="memberContainer">
							<div class="tab-content">
								<div class="tab-pane active" id="home" role="tabpanel"
									aria-labelledby="home-tab">
									<div class="d-flex flex-row w-100 p-3">
										<img src="${member.avatar.name}" alt="avatar"
											class="d-flex align-self-center me-3 rounded-4" width="60"
											height="60" />
										<div class="d-flex flex-column">
											<p class="fw-bold mb-0">${member.name}</p>
											<p class="small text-muted">${ member.position.name }</p>
										</div>
									</div>

									<ul class="list-unstyled mb-0 w-100" id="messengerMemberList"></ul>
								</div>
								<div class="tab-pane" id="messages" role="tabpanel"
									aria-labelledby="messages-tab">
									<ul class="list-unstyled mb-0 w-100" id="messageList"></ul>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="modal fade" id="profileModal" data-bs-backdrop="static"
		data-bs-keyboard="false" tabindex="-1" aria-labelledby="profileModal"
		aria-hidden="true">
		<div
