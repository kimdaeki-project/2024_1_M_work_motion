...
.sign_type1_inline .sign_rank,
.sign_type1_inline .sign_name,
.sign_type1_inline .sign_position,
.sign_type1_inline .sign_type,
...
.go_wrap section.my_info ul.ctrl li a.btn_noti {
    background: url(../images/ic_snb.png?v3.0) no-repeat -50px -100px !important;
}
...
.go_wrap header.go_header_2row nav ul li:hover span.menu,
.go_wrap header.go_header_2row nav ul li.on span.menu {
    color: #fff !important;
}
...
.go_wrap header.go_header_advanced nav span.ctrl_workspace span.wide {
    background: url(../images/ic_gnb_advanced.png?v3.0) no-repeat -50px -121px;
}

.go_wrap header.go_header_advanced nav span.ctrl_workspace span.normal {
    background: url(../images/ic_gnb_advanced.png?v3.0) no-repeat -100px -121px;
}
...
.go_skin_advanced .go_wrap section.my_info ul.ctrl li a.btn_noti {
    background: url(../images/ic_snb.png?v3.0) no-repeat -50px -50px !important;
}
...
<body> 
    ...
    <span>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; width: 272px; height: 24px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
                                       <input type="text" class="form-control" value="${member.position.name}">
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                    ...
                                    <td
                                        style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; width: 272px; height: 24px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
                                        <input type="text" class="form-control" id="create_dt" name="create_dt">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                    <td id="modal-approval" style="background: white; padding: 0px !important; border: currentColor; border-image: none; width: 293px; text-align: right; color: black; font-size: 12px; font-weight: normal; vertical-align: top;">
                        <p
                            style="text-align: right; line-height: 150%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 9pt; margin-top: 0px; margin-bottom: 0px;">
                            <span id="approval-list" class="sign_type1_inline"style="font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 9pt;"
                                data-is-reception="" data-group-type="type1" data-group-max-count="7" data-group-name="결재선" data-group-seq="0">
                                <input type="hidden" id="approval-member-id" name="approval">                              
                                ...
                                <span class="sign_member_wrap" id="">
                                    <span class="sign_member">
                                        <span class="sign_rank_wrap">
                                            <span class="sign_rank" data-department-id="0" id="approvla-department-name0"></span>
                                        </span>
                                        <span class="sign_wrap">
                                            <span class="sign_name" data-name-id="0" id="approval-name0"></span>
                                        </span>
                                        <span class="sign_date_wrap">
                                            <span class="sign_date " >결재</span>
                                        </span>
                                    </span>
                                </span>
                                <span class="sign_member_wrap" id="">
                                    <span class="sign_member">
                                        <span class="sign_rank_wrap">
                                            <span class="sign_rank" data-department-id="1" id="approvla-department-name1"></span>
                                        </span>
                                        <span class="sign_wrap">
                                            <span class="sign_name" data-name-id="1" id="approval-name1"></span>
                                        </span>
                                        <span class="sign_date_wrap">
                                            <span class="sign_date " >결재</span>
                                        </span>
                                ...
                                <span class="sign_member_wrap" id="">
                                    <span class="sign_member">
                                        <span class="sign_rank_wrap">
                                            <span class="sign_rank" data-department-id="2" id="approvla-department-name2"></span>
                                        </span>
                                        <span class="sign_wrap">
                                            <span class="sign_name" data-name-id="2" id="approval-name2"></span>
                                        </span>
                                        <span class="sign_date_wrap">
                                            <span class="sign_date " >결재</span>
                                        </span>
                        ...
                        <button type="button" class="btn btn-primary approval-btn" data-bs-toggle="modal" data-bs-target="#approvalModal">
                            직원리스트
                        </button>  
                ...
                <tr>
                    ...
                    <td id="budgetTeamInfo" style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; height: 10px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
                        ...
                        <input type="hidden" id="member_id_add" name="referrer">
                            ...
                            <button type="button" class="btn btn-primary modal-btn" data-bs-toggle="modal" data-bs-target="#referrerModal">
                                직원리스트
                            </button>                       
        ...
        <table
            style="border: 0px solid rgb(0, 0, 0); border-image: none; width: 800px; height: 206px; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; margin-top: 1px; border-collapse: collapse;">
            <tbody>
                <tr>
                ...
                <tr>
                    <td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; height: 178px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
...
function getCurrentDate() {
    ...
    let fm = "${dto.file_nm}";
    let file_number = fm +"-"+ getCurrentDate() + randomNum;

    document.getElementById('file-number').value = file_number;
    </script>
